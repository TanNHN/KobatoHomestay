 ...
 * @author Tan
 */
public class ViewMyBookingController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int aID = Integer.parseInt(session.getAttribute("ID").toString());
            List<BookingDTO> list;
            BookingDAO bookingDAO = new BookingDAO();
            list = bookingDAO.getBookingBasedOnStatus(aID, false);
            request.setAttribute("BOOKING_LIST", list);
        } catch (Exception e) {
            log("ERROR AT VIEW MY BOOKING CONTROLLER: " + e.getMessage());
        } finally {
