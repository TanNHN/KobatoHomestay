...
public class CheckOutController extends HttpServlet {
    ...
    private static final String SUCCESS = "ShowAllBookedRoomController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean check = bookingDAO.checkOutRoom(bookingID, roomID);
            if (check) {
                url = SUCCESS;
            }else{
                request.setAttribute("ERROR", "CHECK OUT ROOM FAILED");
            }
        } catch (Exception e) {
