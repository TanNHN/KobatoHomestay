 ...
 * @author Tan
 */
public class ShowRoomDetailController extends HttpServlet {

    private static final String FAIL = "error.jsp";
    private static final String SUCCESS = "booking_page.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dto = dao.getRoomFromID(roomID);
            request.setAttribute("ROOM", dto);
            url = SUCCESS;

        } catch (Exception e) {
            log("ERROR at Show Room Detail Controller" + e.getMessage());
        } finally {
